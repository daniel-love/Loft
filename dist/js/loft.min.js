...
_current.removeClass("active");_body.hide();_current=$(this);_body=$($(this).attr("href"));_current.addClass("active");_body.show()})})};$.fn.scrollTo=function(options){var options=$.extend({speed:2E3,ease:"swing"},options);$("html, body").animate({scrollTop:$(this).offset().top},options["speed"],options["ease"])};$.fn.lightbox=function(tag,options){var options=$.extend({fadeIn:false,speed:100},options);return this.find(tag).click(function(e){if($(".lightbox").length==0){e.preventDefault();var _image=
